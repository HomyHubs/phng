...
| Cơ chế triển khai đã chọn (mục 3) | Lát cắt dọc / Lát cắt ngang / hỗn hợp theo milestone |
...
**Cơ chế triển khai đang dùng (mục 3):** [ ] Lát cắt dọc — [ ] Lát cắt ngang — [ ] Hỗn hợp theo milestone

**Profile công nghệ áp dụng (mục 2):** [ ] Web app FE+BE (`docs/methodology/webapp-template.md`) — [ ] Không áp profile nào
